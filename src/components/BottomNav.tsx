...
export const BottomNav: React.FC<BottomNavProps> = ({ activeTab, setActiveTab, onOpenModal }) => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/90 dark:bg-zinc-900/90 backdrop-blur-lg border-t border-zinc-200/50 dark:border-zinc-800/50 pb-safe shadow-[0_-4px_24px_rgba(0,0,0,0.04)]">
      <div className="max-w-md mx-auto px-6 h-16 flex items-center justify-between relative">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center flex-1 py-1 transition-all duration-300 ${
            activeTab === 0
              ? 'text-[#6f8d6d] scale-105'
              : 'text-zinc-400 dark:text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-400'
          }`}
        >
          <Home size={22} strokeWidth={activeTab === 0 ? 2.5 : 2} />
          <span className="text-[10px] mt-1 tracking-wide font-vietnam font-semibold">Tổng quan</span>
        </button>

        {/* Tab 1: Categories / Budget */}
        <button
        ...
        >
          ...
          <span className="text-[10px] mt-1 tracking-wide font-vietnam font-semibold">Ngân sách</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] mt-1 tracking-wide font-vietnam font-semibold">Tính Nợ</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] mt-1 tracking-wide font-vietnam font-semibold">Cá nhân</span>
        </button>
