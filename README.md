...
### 6. Xoay vòng dữ liệu chi tiêu thông minh
*   **Update theo tháng/năm/chu kỳ**: Mỗi 1 tháng trôi qua, tất cả dữ liệu chi tiêu của tháng trước đó sẽ được tổng hợp lại thành 2 trường dữ liệu là tổng chi tiêu và tổng thu nhập, xóa hết data trước đó để làm nhẹ database. Mỗi năm cũng sẽ tổng kết lại chi tiêu và thu nhập và xóa hết tổng chi tiêu/thu nhập các tháng. Chu kỳ 5 năm sẽ diễn ra các hoạt động như trên.

### 7. Thông bao chi tiêu qua email mỗi tháng
*   **Tổng kết chi tiêu/thu nhập qua email**: Mỗi tháng sau khi tổng kết mọi thứ từ giao dịch, danh mục, nợ/vay, hệ thống sẽ gửi 1 email báo cáo cho user để diễn tả chi tiết tháng vừa qua bạn đã chi tiêu như thế nào, danh mục bạn setup trước đó có lố budget hay là không, các khoản nợ/vay đã gạch hết chưa hay vẫn còn,...
---
